...
const Sidebar = () => {
  const { user, canManageUsers, canViewAllBranches } = useAuth();
  ...
  return (
    <aside
      className={`fixed left-0 top-0 z-sticky h-screen bg-white border-r border-slate-200 transition-all duration-300 ${
